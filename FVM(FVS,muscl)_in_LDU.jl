...
###################################################
    ...
    while con == 0
        ...
        for i in 1:nx
            ...
            for l in 1:3
                for m in 1:3
                    temp1[l,m] = yacobiA[i,l,m]
                end
                temp2[l] = delta_Q[i,l]
            end
            temp = nm_inner_product(temp1,temp2)
...
function main()
    ...
    for t in 1:nstep
        ...
        Qc = boundary(nx,gamma,qf,Qc,bdcon)
        QcL,QcR,qfL,qfR = muscl(Qc,qf,nx,k_muscl,b_muscl,gamma)
